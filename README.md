...
that role can only touch this repo's own `neobank-<env>-neo-06` stack. You never hold AWS
credentials yourself — everything that reaches AWS goes through a workflow in this repo.

The front-end image is built with `APP_BASE_PATH=/neo-06`, because in the deployed stack
...
|---|---|---|---|
| **dev** | [`/neo-06/`](http://neobank-dev-571740187.ap-southeast-1.elb.amazonaws.com/neo-06/) | [`/neo-06/health`](http://neobank-dev-571740187.ap-southeast-1.elb.amazonaws.com/neo-06/health) · [`/neo-06/info`](http://neobank-dev-571740187.ap-southeast-1.elb.amazonaws.com/neo-06/info) | [orchestrator](http://neobank-dev-571740187.ap-southeast-1.elb.amazonaws.com/) |
| **prod** | [`/neo-06/`](http://neobank-prod-294820685.ap-southeast-1.elb.amazonaws.com/neo-06/) | [`/neo-06/health`](http://neobank-prod-294820685.ap-southeast-1.elb.amazonaws.com/neo-06/health) · [`/neo-06/info`](http://neobank-prod-294820685.ap-southeast-1.elb.amazonaws.com/neo-06/info) | [orchestrator](http://neobank-prod-294820685.ap-southeast-1.elb.amazonaws.com/) |
...
A `reset` destroys **only this service's schema** (`neo_06`). Every other service and the
...
DB_URL=jdbc:mysql://localhost:3307/neo_06 ./mvnw spring-boot:run
```
...
```json
{ "serviceId": "neo06", "status": "ACCEPTED",
...
| Env | Default | What |
|---|---|---|
| `SERVICE_ID` | `neo06` | the id sent on callbacks — note **no `-a`**, unlike the repo name |
| `SERVICE_NAME` | `Agreement Management` | display name |
...
- `backend/` and `frontend/` **stay at the repo root** — the system compose builds
  `./neo-06/backend` and `./neo-06/frontend` by path.
